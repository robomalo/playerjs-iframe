(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("playerjs-iframe", [], factory);
	else if(typeof exports === 'object')
		exports["playerjs-iframe"] = factory();
	else
		root["playerjs-iframe"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adapters = __webpack_require__(71);
	...
	var PlayerjsIframe = function () {
	  /**
	   * Create a Player.js iframe
	   * @param {Object} config
	   */

	  function PlayerjsIframe() {
	    var config = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

	    _classCallCheck(this, PlayerjsIframe);

	    this.Adapter = _adapters2.default[config.schema];
	    ...
	    this.messenger = new _messenger2.default({
	  ...
	  _createClass(PlayerjsIframe, [{
	    key: 'addAdapter',
	    value: function addAdapter(name, adapter) {
	      _adapters2.default[name] = adapter;
	    }
	  ...
	  return PlayerjsIframe;
	}();

	exports.default = PlayerjsIframe;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Set) {'use strict';
	...
	var _postMessage = __webpack_require__(69);
	...
	var Messenger = function () {
	  ...
	  _createClass(Messenger, [{
	    ...
	    value: function bindEvents() {
	      ...
	      this.on(_constants.METHODS.ADD_EVENT_LISTENER, function (value, data) {
	        _this.listeners[data.value] = new Set(_this.listeners[data.value]);
	        _this.listeners[data.value].add(data.listener);
	      });

	      // Handle all calls to `removeEventListener`
	      this.on(_constants.METHODS.REMOVE_EVENT_LISTENER, function (value, data) {
	        if (_this.listeners[data.value]) {
	          _this.listeneres[data.value].delete(data.listener);
	        }
	      });
	    }
	    ...
	    value: function on(method, callback) {
	      ...
	      window.addEventListener('message', function (event) {
	        ...
	        try {
	          ...
	          if (!_this2.config.context || data.context === _this2.config.context) {
	    ...
	    value: function emit(data) {
	      ...
	      data = Object.keys(this.config).reduce(function (data, key) {
	        if (!data.hasOwnProperty(key)) {
	          data[key] = _this3.config[key];
	        }
	      ...
	      if (data.event === _constants.EVENTS.READY) {
	        (0, _postMessage2.default)(data);
	      } else {
	        ...
	        var listeners = data.listener ? [data.listener] : this.listeners[data.event] || [];
...
/***/ function(module, exports) {
	...
	var CONTEXT = exports.CONTEXT = 'player.js';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vimeo = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iframe = __webpack_require__(80);

	var _iframe2 = _interopRequireDefault(_iframe);

	var _getScript = __webpack_require__(81);
	...
	var VIMEO_API_SCRIPT = '//player.vimeo.com/api/player.js';

	var SUPPORTED_METHODS = [_constants.METHODS.PLAY, _constants.METHODS.PAUSE, _constants.METHODS.GET_PAUSED, _constants.METHODS.MUTE, _constants.METHODS.UNMUTE, _constants.METHODS.GET_MUTED, _constants.METHODS.SET_VOLUME, _constants.METHODS.GET_VOLUME, _constants.METHODS.GET_DURATION, _constants.METHODS.SET_CURRENT_TIME, _constants.METHODS.GET_CURRENT_TIME];

	var SUPPORTED_EVENTS = [_constants.EVENTS.PROGRESS, _constants.EVENTS.TIMEUPDATE, _constants.EVENTS.PLAY, _constants.EVENTS.PAUSE, _constants.EVENTS.ENDED, _constants.EVENTS.SEEKED, _constants.EVENTS.ERROR];

	/**
	  * The Vimeo video adapter interface
	  */

	var VimeoAdapter = function (_BaseAdapter) {
	  _inherits(VimeoAdapter, _BaseAdapter);
	  ...
	  function VimeoAdapter() {
	    _classCallCheck(this, VimeoAdapter);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(VimeoAdapter).apply(this, arguments));

	    _this.supportedEvents = SUPPORTED_EVENTS;
	    _this.supportedMethods = SUPPORTED_METHODS;


	    var getApi = new Promise(function (resolve, reject) {
	      (0, _getScript2.default)(VIMEO_API_SCRIPT).then(resolve);
	    });
	  ...
	  _createClass(VimeoAdapter, [{
	    key: 'init',
	    value: function init() {
	      var _this2 = this;

	      var iframe = new _iframe2.default('' + this.config.src + this.config.videoId);
	      ...
	      this.player.ready().then(function () {
	        SUPPORTED_EVENTS.forEach(function (eventName) {
	          _this2.player.on(eventName, function () {
	            _this2.messenger.emit(eventName);
	          });
	        });
	    ...
	    key: 'getPaused',
	    value: function getPaused(data) {
	      var _this3 = this;

	      this.player.getPaused().then(function (paused) {
	        _this3.messenger.returns(data, paused);
	      });
	    }
	    ...
	    key: 'getMuted',
	    value: function getMuted(data) {
	      var _this5 = this;

	      this.player.getVolume().then(function (volume) {
	        _this5.messenger.returns(data, volume === 0);
	      });
	    }
	    ...
	    value: function setVolume(data) {
	      ...
	      this.player.setVolume((data.value / 100).toFixed(2)).then(function (volume) {
	        _this6.lastVolume = volume;
	      });
	    }
	    ...
	    key: 'getVolume',
	    value: function getVolume(data) {
	      var _this7 = this;

	      this.player.getVolume().then(function (volume) {
	        _this7.lastVolume = volume;
	        _this7.messenger.returns(data, Math.round(volume * 100));
	      });
	    }
	    ...
	    value: function getDuration(data) {
	      ...
	      this.player.getDuration().then(function (duration) {
	        _this8.messenger.returns(data, duration);
	      });
	    }
	    ...
	    value: function getCurrentTime(data) {
	      ...
	      this.player.getCurrentTime().then(function (seconds) {
	        _this9.messenger.returns(data, seconds);
	      });
	    }
	...
	VimeoAdapter.lastVolume = 100;
	exports.default = VimeoAdapter;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseAdapter = function () {
	  function BaseAdapter(config, messenger) {
	  ...
	  _createClass(BaseAdapter, [{
	    ...
	    value: function ready() {
	      ...
	      this.supportedMethods.forEach(function (method) {
	        _this.messenger.on(method, function (value, data) {
	          if (_this[method]) {
	            _this[method](data);
	          }
	        });
	      ...
	      if (this.supportedEvents.length > 0) {
	        this.supportedMethods.push(_constants.METHODS.ADD_EVENT_LISTENER, _constants.METHODS.REMOVE_EVENT_LISTENER);
	      }

	      // Emit that the player is ready
	      this.messenger.emit({
	        event: _constants.EVENTS.READY,
	        value: {
...
/***/ function(module, exports) {
	...
	var Iframe = function () {
	  ...
	  function Iframe(src, attributes) {
	    ...
	    attributes = _extends({}, DEFAULT_ATTRIBUTES, attributes);

	    this.iframe = document.createElement(IFRAME);

	    Object.keys(attributes).forEach(function (key) {
	      _this.iframe.setAttribute(key, attributes[key]);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @type {String}
	 */
	var SCRIPT_PARENT = document.head || document.body;

	/**
	 * Script ready events
	 * @type {RegExp}
	 */
	var READY_EVENTS = /loaded|complete/;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var YOUTUBE_API_SCRIPT = '//www.youtube.com/iframe_api';

	var SUPPORTED_METHODS = [_constants.METHODS.PLAY, _constants.METHODS.PAUSE, _constants.METHODS.GET_PAUSED, _constants.METHODS.MUTE, _constants.METHODS.UNMUTE, _constants.METHODS.GET_MUTED, _constants.METHODS.SET_VOLUME, _constants.METHODS.GET_VOLUME, _constants.METHODS.GET_DURATION, _constants.METHODS.SET_CURRENT_TIME, _constants.METHODS.GET_CURRENT_TIME];

	var SUPPORTED_EVENTS = [_constants.EVENTS.PLAY, _constants.EVENTS.PAUSE, _constants.EVENTS.ENDED, _constants.EVENTS.ERROR];
	...
	var YouTubeAdapter = function (_BaseAdapter) {
	  _inherits(YouTubeAdapter, _BaseAdapter);
	  ...
	  function YouTubeAdapter() {
	    _classCallCheck(this, YouTubeAdapter);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(YouTubeAdapter).apply(this, arguments));
	    ...
	    var getApi = new Promise(function (resolve, reject) {
	      ...
	      (0, _getScript2.default)(YOUTUBE_API_SCRIPT);
	    });
	      ...
	      this.player = new YT.Player(videoContainer, {
	        ...
	        events: {
	          ...
	          onError: function onError() {
	            _this2.messenger.emit({
	              event: _constants.EVENTS.ERROR,
	              value: {
	                code: -1,
	          ...
	          onStateChange: function onStateChange(event) {
	            var events = {
	              0: _constants.EVENTS.ENDED,
	              1: _constants.EVENTS.PLAY,
	              2: _constants.EVENTS.PAUSE
	            };

	            if (events[event.data]) {
	              _this2.messenger.emit(events[event.data]);
	            }
	          }
	        }
	      });
